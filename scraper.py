#!/usr/bin/env python3
"""
Google Place ID API - Get Google Place IDs without API key - free alternative
Open source scraper for google place id api, place id api, google place id scraper
...
class GooglePlaceIdApiScraper:
    """Scraper for Google Place ID API."""
...
def main():
    parser = argparse.ArgumentParser(description="Google Place ID API - Get Google Place IDs without API key - free alternative")
    ...
    scraper = GooglePlaceIdApiScraper(proxy=args.proxy)
