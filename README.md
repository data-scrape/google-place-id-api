# 🗺️ Google Place ID API

> Get Google Place IDs without API key - free alternative

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/google-place-id-api?style=flat-square)](https://github.com/data-scrape/google-place-id-api)
[![Forks](https://img.shields.io/github/forks/data-scrape/google-place-id-api?style=flat-square)](https://github.com/data-scrape/google-place-id-api/forks)
...
**Google Place ID API** is a free, open-source Python scraper for **Google Place ID**. Extract structured data from google place id with full pagination support, proxy rotation, and multiple export formats.

google place id api, place id api, google place id scraper

## ✨ Features

- ✅ Get Place ID without API key
- ✅ Search by business name
- ✅ Search by address
- ✅ Batch Place ID lookup
...
```bash
git clone https://github.com/data-scrape/google-place-id-api.git
cd google-place-id-api
...
```bash
python scraper.py "Place ID for Empire State Building"
```
...
`place_id` | `business_name` | `address` | `latitude` | `longitude` | `place_types` | `formatted_address`

## 💡 Use Cases

- Google Maps integration without API
- Local business data enrichment
- Place ID lookup tool
- SEO local search tools
